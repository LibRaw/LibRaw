...
enum LibRaw_dng_processing
{
	...
	LIBRAW_DNG_FLOAT=1,
	LIBRAW_DNG_LINEAR=2,
	LIBRAW_DNG_2SAMPLES=4,
	LIBRAW_DNG_XTRANS=8,
	LIBRAW_DNG_FUJIROTATED=16,
	LIBRAW_DNG_OTHER=32,
	//LIBRAW_DNG_LARGERANGE=64, // more than 16 bit integer
	LIBRAW_DNG_ALL = LIBRAW_DNG_FLOAT|LIBRAW_DNG_LINEAR|LIBRAW_DNG_2SAMPLES|LIBRAW_DNG_XTRANS|LIBRAW_DNG_FUJIROTATED|LIBRAW_DNG_OTHER /* |LIBRAW_DNG_LARGERANGE */,
